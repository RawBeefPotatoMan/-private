import { ICalendarHeaderProp as MbscCalendarHeaderOptions } from '../../core/shared/calendar-view/calendar-header';
...
export { CalendarNext, CalendarPrev, CalendarToday, CalendarNav, MbscCalendarHeaderOptions };
